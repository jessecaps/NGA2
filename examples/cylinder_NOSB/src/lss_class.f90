...
module lss_class
   ...
   integer, parameter, public :: max_bond=130  !< Assumes something like a 7x7x7 stencil in 3D
   ...
   type :: part
      ...
      real(WP), dimension(3) :: t1       !< Fluid acceleration for particle
      real(WP), dimension(3) :: t2       !< Fluid acceleration for particle
      real(WP), dimension(3) :: tc       !< Fluid acceleration for particle
   ...
   integer           , dimension(part_nblock) :: part_lblock=[48+max_bond,7+max_bond]
...
contains
   ...
   subroutine advance(this,dt,stress_x,stress_y,stress_z)
      ...
      do n=1,this%np_
         ...
         this%p(n)%correcMag = sqrt(dot_product(this%p(n)%Afluid,this%p(n)%Afluid))
   ...
   subroutine update_VF(this)
      ...
      ! Clip
      !where (this%VF.ge.1.0_WP) this%VF=1.0_WP
